...
- [ ] 42-09-PLAN.md — Live end-to-end against genuine stock VICE on this host: all five formats parsed from a live reply, the probe's real cache key, and the RAM-execute outcome recorded either way
...
| 42. The Text-Format Parsers and Their Two-Binary Fixtures | v0.9.0 | 8/9 | In Progress | - |
