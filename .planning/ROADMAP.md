...
- [ ] 42-07-PLAN.md — The four remaining tools, classify-before-parse in all five handlers, the shared backtrace name and its registry consequence, and the published file set
- [ ] 42-08-PLAN.md — The structural single-owning-module guard: family floor, injective owner map, closed per-format literal and importer sets, byte-safe census, planted-violation control
