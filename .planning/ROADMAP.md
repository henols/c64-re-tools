...
- [ ] 34-09-PLAN.md — Gap 2: the control-plane round trip's connect timer split from a per-tool request deadline, per-tool server-side budgets clearing the measured JVM-startup cost, a slow tool observed completing over the real route, then the SEAM-02 ledger repair (CR-04)
...
| 34. The Host-Tool Execution Seam | v0.8.0 | 8/9 | In Progress | - |
