...
**Plans**: 10/14 plans executed — 9/9 original plans executed in 4 waves, plus 5 gap-closure plans (42-10..42-14) added in 3 further waves after verification returned `gaps_found`
...
| 42. The Text-Format Parsers and Their Two-Binary Fixtures | v0.9.0 | 10/14 | In Progress | - |
