...
- [ ] 19-16-PLAN.md — make the second true-returning site consult the pairing too: the indirect jump must name the vector the two paired loads built, not any consecutive pair in the window
