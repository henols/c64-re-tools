...
- [ ] 34-08-PLAN.md — Gap 1b: `oracle.probe`'s `command` wire key removed, the oracle located from the host broker's own environment with a basename check, and a declared path-argument census that catches the next unresolved key (CR-01)
