...
- `.planning/phases/50-equivalence-and-modifiability/evidence/phase50-equivalence-transcript.md` — the instrument, the capture
  procedure, the mask calibration, the red control on a planted regression, and
  the green comparison against the rebuild.
- `.planning/phases/50-equivalence-and-modifiability/evidence/phase50-modifiability-transcript.md` — one behaviour removed and one
...
procedure is not restated here — `.planning/phases/50-equivalence-and-modifiability/evidence/phase50-equivalence-transcript.md`'s
...
`.planning/phases/50-equivalence-and-modifiability/evidence/phase50-equivalence-transcript.md`, line 13, the `hazard-subject` subject's
...
**The revert.** `git checkout -- .planning/phases/50-equivalence-and-modifiability/evidence/phase50-equivalence-transcript.md`, after
which `git status --porcelain .planning/phases/50-equivalence-and-modifiability/evidence/phase50-equivalence-transcript.md
.planning/phases/50-equivalence-and-modifiability/evidence/phase50-modifiability-transcript.md src/mcp/vice/fixtures/hazard-subject`
printed nothing.
