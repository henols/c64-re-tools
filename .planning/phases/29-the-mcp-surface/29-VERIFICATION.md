...
| `src/mcp/vice/anno-cli.ts`, `vice-proxy.ts`, `scripts/lib/anno-cli-verbs.mjs`, `scripts/check-npm-packages.mjs` | :866/:893/:902, :300, :62, :236-239 | Mechanical rename left user-facing strings and cross-references on the retired vocabulary (`r2000: unknown verb`, `runR2000Cli`, `VICE_TEST_R2000_CLI_STDOUT_FILL_BYTES`, `extractedR2000.size >= 10`) | ⚠️ WARNING | WR-14. |
