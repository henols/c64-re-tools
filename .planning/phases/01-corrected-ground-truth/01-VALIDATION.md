...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 1-01-* | 01 | 1 | DOC-01 | — | N/A (docs) | content-assertion | `grep -c "no real ergonomic wrinkle\|cannot be a stopwatch\|compile-time \*feature\*" docs/phase0-binmon-findings.md` → expect `0` | ❌ W0 | ⬜ pending |
| 1-01-* | 01 | 1 | DOC-01 | — | N/A (docs) | content-assertion | `grep -c "VICE ≥ 3.10\|VICE >= 3.10" .planning/intel/constraints.md` → expect `>=1` | ❌ W0 | ⬜ pending |
| 1-01-* | 01 | 1 | DOC-02 | — | N/A (docs) | content-assertion | `grep -l "RL.*CY" docs/phase0-binmon-findings.md docs/stock-vice-parity.md` → expect both files listed | ❌ W0 | ⬜ pending |
| 1-01-* | 01 | 1 | DOC-03 | — | N/A (docs) | content-assertion | `grep -A2 "CON-stopwatch-via-cpuhistory" .planning/intel/constraints.md \| grep -c PROVISIONAL` → expect `0` | ❌ W0 | ⬜ pending |
| 1-02-* | 02 | 1 | VERIF-01 | — | N/A (probe) | artifact-existence | `test -f docs/phase1-probe-results.md && grep -c "PALETTE_GET" docs/phase1-probe-results.md` → file exists, `>=1` | ❌ W0 | ⬜ pending |
| 1-02-* | 02 | 1 | VERIF-04 | — | N/A (probe) | content-assertion | all five UNVERIFIED items appear in `docs/phase1-probe-results.md`, each marked resolved or accepted-unknown (count = 5) | ❌ W0 | ⬜ pending |
