...
tech-stack:
  ...
  patterns:
    ...
    - "Shipped-module invariant via package.json files[]: the same shippedTsModules() idiom r2000-spawn-seam.test.ts established, reused here to scan for a competing capability-refusal wording"
