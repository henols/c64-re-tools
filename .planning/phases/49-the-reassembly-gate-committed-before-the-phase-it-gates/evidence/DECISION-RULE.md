...
(`docs/phase49-the-reassembly-gate-findings.md`) records an explicit override. The rule text
...
(`docs/phase49-the-reassembly-gate-findings.md`) rather than silently corrected here.
