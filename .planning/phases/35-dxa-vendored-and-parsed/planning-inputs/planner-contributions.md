<!-- ===== plan:pre capability contribution: ai-integration (binding) ===== -->
...
<!-- ===== plan:pre capability contribution: assumption-delta (binding) ===== -->
...
<!-- ===== plan:pre capability contribution: schema-gate (binding) ===== -->
...
<!-- ===== plan:pre capability contribution: security (binding) ===== -->
...
**Resolved configValues for security:** {"security_asvs_level":1,"security_block_on":"high"}
