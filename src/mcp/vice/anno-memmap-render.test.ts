...
test(
  ...
  async () => {
    ...
    const result = await renderMemoryMap({ storePath: projectPath, provenancePath, workspaceRoot: HERE });
    ...
    const inSync = await checkRenderedMemoryMap({ storePath: projectPath, provenancePath, renderedPath, workspaceRoot: HERE });
    ...
    const drifted = await checkRenderedMemoryMap({ storePath: projectPath, provenancePath, renderedPath, workspaceRoot: HERE });
    ...
    const storeDrift = await checkRenderedMemoryMap({ storePath: projectPath, provenancePath, renderedPath, workspaceRoot: HERE });
...
test(
  ...
  async () => {
    ...
    try {
      ...
      const noComments = await renderMemoryMap({ storePath: projectPath, provenancePath, workspaceRoot: HERE });
      ...
      const withUnknown = await renderMemoryMap({ storePath: projectPath, provenancePath, workspaceRoot: HERE });
