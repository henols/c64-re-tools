...
//       surface was too; the CLI is reached from `vice-proxy.ts:304` plus
...
//     family.
//   - `checkAcceptedOptions` (`anno-cli.ts:409`) is a generic argv option
...
export const MODULE_CLASSIFICATION: readonly ModuleClassificationEntry[] = [
  ...
  // --- glue: the rented analyser is the whole subject ---
  {
    ...
    basis: {
      consumers: [
        { path: "src/mcp/vice/vice-proxy.ts", symbol: "runAnnoCli", line: 304 },
