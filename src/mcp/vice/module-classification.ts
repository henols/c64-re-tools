...
//     family.
//   - `checkAcceptedOptions` (`anno-cli.ts:445`) is a generic argv option
...
export const MODULE_CLASSIFICATION: readonly ModuleClassificationEntry[] = [
  ...
  },
  {
    ...
    basis: {
      consumers: [
        { path: "src/mcp/vice/anno-cli.ts", symbol: "buildCoverageReport", line: 141 },
  ...
  },
  {
    ...
    basis: {
      consumers: [
        { path: "src/mcp/vice/anno-cli.ts", symbol: "renderMemoryMap", line: 128 },
    ...
    note:
      ...
      "route (never hand-author an address row) at src/skills/c64-program-recon/SKILL.md:256.",
  },
  {
