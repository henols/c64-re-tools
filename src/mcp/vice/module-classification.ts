...
export const MODULE_CLASSIFICATION: readonly ModuleClassificationEntry[] = [
  ...
  },
  {
    ...
    basis: {
      consumers: [
        { path: "src/mcp/vice/anno-cli.ts", symbol: "buildCoverageReport", line: 99 },
  ...
  },
  {
    ...
    note:
      ...
      "src/skills/c64-program-recon/SKILL.md:298, and that guidance outlives the analyser.",
  },
  {
  ...
  },
  {
    ...
    basis: {
      consumers: [
        { path: "src/mcp/vice/anno-cli.ts", symbol: "renderMemoryMap", line: 94 },
