...
// otherwise. See `docs/phase50-ci-boundary.md` for the full boundary.
...
const REFRESH_REMEDY =
  ...
  "genuine stock VICE (docs/phase50-ci-boundary.md, section \"How to run each half\") and commit a fresh " +
  "transcript. Do NOT hand-edit the recorded digest to match: that reinstates the stale record this check exists to catch.";
