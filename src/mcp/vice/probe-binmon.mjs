 ...
 *   node src/mcp/vice/probe-binmon.mjs --capture <case>
 *   node src/mcp/vice/probe-binmon.mjs --capture all [--capture-out <dir>]
 ...
 *   node src/mcp/vice/probe-binmon.mjs --probe-assumptions=A1,A3 [host] [port]
